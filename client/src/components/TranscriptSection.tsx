...
const TranscriptSection = ({
  ...
  return (
    <section aria-labelledby="transcript-heading" className="w-full max-w-full" style={{display: 'block'}}>
      <div className="bg-background p-6 rounded-lg shadow-md border-2 border-primary/30 w-full max-w-full flex flex-col">
