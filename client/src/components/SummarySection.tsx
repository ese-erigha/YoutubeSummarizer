...
const SummarySection = ({
  ...
  return (
    <section aria-labelledby="summary-heading" className="w-full block">
      <div className="bg-background p-6 rounded-lg shadow-md border-2 border-secondary/40 w-full flex flex-col">
